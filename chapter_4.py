...
# j = 0
# a = int(input())
# list_a = list(map(int, input().split()))[:a]
# b = int(input())
# list_b = list(map(int, input().split()))[:b]
...
#         break
#     else:
#         if list_a[i] == list_b[j] or list_a[i] == list_b[j] - 1 or list_a[i] == list_b[j] + 1:
#             count += 1
#             i += 1
#             j += 1
#         else:
...
"""
Гипотеза Коллатца
Сиракузская последовательность, или последовательность Коллатца, строится так: возьмём натуральное число n; если оно чётное, 
