...
"""
При помощи list comprehension создайте список, состоящий из нечетных натуральных чисел в интервале [n; n^2] и вывести 
его на экран. Само число nn поступает на вход программе
Формат ввода:
...
# #Блок решения
# if a <= b:
#     h = [i ** 2 for i in range(a, b + 1)]
# else:
#     h = [i ** 3 for i in range(a, b - 1, -1)]
#
# #Блок вывода
# print(h)
...
В качестве ответа выведите полученный список, слова в нем должны стоять в том же порядке, в котором они стояли 
в изначальной фразе
"""
